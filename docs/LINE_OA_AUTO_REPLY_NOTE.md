...
- 加好友 `FollowEvent` → 歡迎 Flex（版本戳 **W250723k**，標題含「❤️ 今天還在嗎」）
...
1. 對 Bot 傳：**開始**
2. 應收到新 Flex：標題「❤️ 今天還在嗎」、footer 黃底 **版本 W250723k**
   - 主按鈕「一鍵邀請守護人」→ `open=share-invite`（LIFF 載入後直接呼叫 shareTargetPicker）
