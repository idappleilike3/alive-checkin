...
- 加好友 `FollowEvent` → 歡迎 Flex（**無版本戳**，標題含「❤️ 今天還在嗎」）
...
1. 對 Bot 傳：**開始**
2. 應收到新 Flex：標題「❤️ 今天還在嗎」、**沒有**黃底版本戳
   - 主按鈕「一鍵邀請守護人」→ `https://liff.line.me/2010674803-rK98c0lo/liff/share-invite.html`（專用分享頁，不經首頁）
