...
def build_guardian_checkin_text(profile, now):
    """å®ˆè­·äººå®‰å¿ƒé€šçŸ¥ï¼›ä¸æ­éœ²æœƒå“¡çš„ä¸‹ä¸€æ¬¡æé†’è¨­å®šã€‚"""
