...
def build_day7_pin_reminder_flex():
    ...
    return {
        "type": "flex",
        "altText": "ä½¿ç”¨ä¸€é€±çš„å°æé†’ï¼šè«‹å°‡æ¯æ—¥å¹³å®‰å®˜æ–¹ LINE ç½®é ‚",
        "contents": {
            "type": "bubble",
            "size": "mega",
            "header": {
                ...
                "contents": [
                    {
                        "type": "text",
                        "text": (
                            "ä½¿ç”¨ä¸€é€±äº†ï¼Œé‚„ç¿’æ…£å—ï¼Ÿå»ºè­°æŠŠã€Œæ¯æ—¥å¹³å®‰ã€å®˜æ–¹å¸³è™Ÿç½®é ‚ï¼Œ"
                            "æ‰ä¸æœƒéŒ¯éå ±å¹³å®‰æé†’èˆ‡å®ˆè­·é€šçŸ¥å–”ï¼"
                        ),
                        "wrap": True,
                        "color": "#33443F",
                    },
                    {
                        "type": "text",
                        "text": (
                            "ç½®é ‚æ–¹å¼ï¼šåœ¨ LINE èŠå¤©åˆ—è¡¨é•·æŒ‰ã€Œæ¯æ—¥å¹³å®‰ã€ï¼Œ"
                            "é¸æ“‡ã€Œé‡˜é¸ã€ã€‚"
                        ),
                        "wrap": True,
                        "margin": "lg",
