...
def update_member_location(data_file, line_user_id, payload, *, source="member"):
    ...
    if len(address) > 120:
        return {"ok": False, "error": "invalid_address", "message": "ä½å€è«‹å‹¿è¶…é 120 å€‹å­—"}, 400
